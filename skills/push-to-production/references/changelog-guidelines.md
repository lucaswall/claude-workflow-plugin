...
- Linear issue numbers (e.g., PROJ-224) — meaningless to users

## Writing Style

- Describe from the user's perspective: "Dashboard now shows weekly progress" not "Added WeeklyChart component"
